...
const blogPosts = [
  {
    id: 1,
    title: 'Guia Prático de RPO/RTO para PMEs',
    slug: 'guia-rpo-rto-pmes',
    excerpt: 'Entenda como definir objetivos de recuperação adequados para seu negócio sem gastar uma fortuna.',
    content: 'RPO (Recovery Point Objective) e RTO (Recovery Time Objective) são métricas fundamentais...',
    category: 'backup',
  ...
  {
    id: 2,
    title: 'Como Saneamos 200k Linhas de Excel Sem Dor',
    slug: 'saneamento-dados-excel',
    excerpt: 'Case real: transformamos planilhas caóticas em dados estruturados em 15 dias.',
    content: 'O cliente chegou até nós com um problema comum: dados espalhados em múltiplas planilhas...',
    category: 'dados',
    author: 'Ana Silva',
    publishedAt: '2024-01-10',
    readTime: '12 min',
    image: 'https://images.pexels.com/photos/590022/pexels-photo-590022.jpeg?auto=compress&cs=tinysrgb&w=600&h=300&fit=crop',
    tags: ['ETL', 'Python', 'Data Cleaning', 'Excel']
  },
  {
    id: 3,
    title: 'Chatbots que Vendem: Do Discovery à Integração com CRM',
    slug: 'chatbots-vendas-crm',
    excerpt: 'Passo a passo para criar chatbots que realmente convertem leads em vendas.',
    content: 'Chatbots não são apenas para FAQ. Quando bem implementados, podem ser poderosas ferramentas de vendas...',
    category: 'automacao',
    ...
    tags: ['Chatbots', 'WhatsApp API', 'CRM', 'Automação']
  },
  {
    id: 4,
    title: '5 Erros Comuns de ETL que Matam seus Dashboards',
    slug: 'erros-etl-dashboards',
    excerpt: 'Evite armadilhas que podem comprometer a confiabilidade dos seus relatórios.',
    content: 'Dashboards bonitos não servem de nada se os dados estão errados. Veja os principais erros...',
    category: 'bi',
    author: 'Guilherme Molina',
    publishedAt: '2023-12-28',
    readTime: '10 min',
    image: 'https://images.pexels.com/photos/590016/pexels-photo-590016.jpeg?auto=compress&cs=tinysrgb&w=600&h=300&fit=crop',
    tags: ['ETL', 'Power BI', 'Data Quality', 'Dashboards']
  },
  {
    id: 5,
    title: 'LGPD para Operações: O Essencial que o Técnico Precisa Saber',
    slug: 'lgpd-operacoes-tecnico',
    excerpt: 'Guia prático para implementar conformidade LGPD sem complicar a operação.',
    content: 'A LGPD não precisa ser um bicho de sete cabeças. Com as práticas certas...',
    category: 'dados',
    author: 'Ana Silva',
  ...
  {
    id: 6,
    title: 'Automação de Backup com PowerShell: Scripts Prontos',
    slug: 'automacao-backup-powershell',
    excerpt: 'Scripts testados e documentados para automatizar backups em Windows Server.',
    content: 'Compartilhamos scripts PowerShell que usamos em produção para automatizar backups...',
    category: 'backup',
    author: 'Ana Silva',
    publishedAt: '2023-12-15',
    readTime: '14 min',
    image: 'https://images.pexels.com/photos/11784506/pexels-photo-11784506.jpeg?auto=compress&cs=tinysrgb&w=600&h=300&fit=crop',
    tags: ['PowerShell', 'Windows Server', 'Automação', 'Scripts']
  }
];
